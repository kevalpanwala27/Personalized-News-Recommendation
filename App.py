...
st.set_page_config(page_title='OnlyNews - News at Your Fingertips', page_icon='./Meta/favicon.ico')
...
def fetch_news_poster(poster_link):
    try:
        ...
        image = Image.open('Meta/Image_not_available.png')
        st.image(image, use_column_width=True)
...
def run():
    st.title("OnlyNews - News at Your Fingertips")
    image = Image.open('./Meta/logo.png')
